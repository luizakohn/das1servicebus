...
public class ServiceBusClientConfiguration {
    ...
    private static final String SUBSCRIPTION_NAME = "subsluizakohn";
    private static final String QUEUE_NAME = "queue-luiza";
    ...
    ServiceBusSenderClient serviceBusTopicQueueClient(ServiceBusClientBuilder builder) {
        return builder
               .sender()
